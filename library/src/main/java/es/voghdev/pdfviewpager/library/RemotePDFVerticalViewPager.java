...
public class RemotePDFVerticalViewPager extends VerticalViewPager implements DownloadFile.Listener {
    protected Context context;
    protected DownloadFile downloadFile;
    protected DownloadFile.Listener listener;

    public RemotePDFVerticalViewPager(Context context, String pdfUrl, DownloadFile.Listener listener) {
        super(context);
    ...
    public RemotePDFVerticalViewPager(Context context,
    ...
    public RemotePDFVerticalViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
