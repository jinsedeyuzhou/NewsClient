...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private int mTitleLeft;//距离左侧边距
    private static int COLOR_TITLE_BG = Color.parseColor("#FFF4F4F4");
    ...
    public SuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        ...
        mTitleLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, context.getResources().getDisplayMetrics());
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft()+mTitleLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, child.getPaddingLeft()+mTitleLeft,
