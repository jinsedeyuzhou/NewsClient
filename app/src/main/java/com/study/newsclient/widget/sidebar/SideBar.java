...
//    private SideBarDataHelper mDataHelper;
     ...
     * @return
     */
    public SideBar setSourceDatasAlreadySorted(boolean sourceDatasAlreadySorted) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.SideBar_indexBarTextSize) {
                textSize = typedArray.getDimensionPixelSize(attr, textSize);
            } else if (attr == R.styleable.SideBar_indexBarPressBackground) {
...
//        mDataHelper = new SideBarDataHelperImpl();
    }
    ...
    public SideBar setmSourceDatas(List<? extends BaseSidePinyinBean> mSourceDatas) {
    ...
    private void initSourceDatas() {
        ...
        if (!isSourceDatasAlreadySorted) {
            //排序sourceDatas
            SideBarDataHelper.sortSourceDatas(mSourceDatas);
        } else {
            //汉语->拼音
            SideBarDataHelper.convert(mSourceDatas);
            //拼音->tag
            SideBarDataHelper.fillInexTag(mSourceDatas);
        }
        if (isNeedRealIndex) {
            SideBarDataHelper.getSortedIndexDatas(mSourceDatas, mIndexDatas);
            computeGapHeight();
        }
        //sortData();
    }
